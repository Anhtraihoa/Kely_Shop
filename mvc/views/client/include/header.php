...
<div class="header_top"><!--header_top-->
		...
		<div class="header-middle" style="height: 80px; background:#ffffff"><!--header-middle-->
			<div class="container">
				<div class="row">
					<div class="col-md-2 clearfix" >
						<div class="logo pull-left">
							<a  href="<?=base?>"><img class="logo-image" style="object-fit:cover;width: 120px;height: 50px;" src="public/images/logo/kely_logo_no_bg_2.svg" alt="" /></a>
						</div>
					</div>
					...
					<div class="col-md-6 clearfix mob-ipa">
						<div class="shop-menu clearfix pull-right">
							...
							<?php }?>
								<li class="trung__subnav" style="position: relative;">
									<a href="<?=base?>cart/showcart">
										<i class="fa fa-shopping-cart"></i> 
										Giỏ Hàng
										
									</a>
									<!-- Thêm số lượng trên cái giỏ hàng khi nhấn thêm vào giỏ hàng -->
									<?php
				...
				<div class="col-md-8 search-box--header">
							<form method="post">
								<div class="search_box">
									<input id="search" type="text" placeholder="Tìm Kiếm Sản Phẩm"/>
									<button id="btn-search" class="fas fa-search btn-search__header btnn"></button >
								</div>
							</form>
						</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						...
						<!-- <div class="col-sm-8 search-box--header">
							<form method="post">
								<div  style="position: relative;" class=" search_box">
									<input id="search" type="text" placeholder="Tìm Kiếm Sản Phẩm"/>
									<button id="btn-search" 
									style="position: absolute; top: 5px; font-size: 23px;right: 3px; color:#999;border: none;background: none;" 
									class="fas fa-search btn-search__header btnn">
								</button >
								</div>
							</form>
						</div> -->
