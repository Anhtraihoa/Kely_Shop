				...
				<div class="row">
					<div class="col-md-2 clearfix">
						<div class="logo pull-left" >
							<a href="<?=base?>"><img style="object-fit:cover; object-fit:cover;width: 120px;height: 50px;" src="public/images/logo/kely_logo_no_bg.svg" alt="" /></a>
						</div>
					</div>
	    		...
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <input type="submit" name="submit" class="btn-back pull-center" value="Gửi">
				            </div>
				        </form>
	    			</div>
	    		</div>
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
							...
							<p>Số Điện thoại: 0332467642</p>
							<p>Email: vothanhtu@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
