<?php
    class ajax extends controller{
        ...
        // Kiểm tra xem tài khoản này có ai sử dụng hay chưa (lúc đki tài khoản)
        function checkuser(){
            $email = $_POST["email"];
        ...
        // Hiện chi tiết sản phẩm khi người dùng bấm vào mua sản phẩm
        function details(){
            $id = $_POST["id"];
            $product = $this->commonmodel->GetProductById($id);
            $listComment = $this->homeclientmodel->ShowComment($id);
            echo '
                <div class="col-sm-12 " style="padding: 1.2rem; ">
                    <i style="font-size: 30px; color:#5D5A88;position: absolute;right: 0;z-index: 2;" class="fas fa-times-circle"></i>
                    <div class="product-details" style="min-height: 470px; padding-top: 3rem;"><!--product-details-->
                        <div class="col-sm-6" style="min-height: 470px; width: 500px; height: 300px;">
                            <div class="view-product">
                                <img style="object-fit: cover; width: 100%; height:100%;" src="public/images/img_product/'.$product[0]["img_product"].'" alt="" />
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <h2 style="color: #5D5A88; font-size: 56px; font-weight: 700; font-style:normal; line-height: 66px;">'.$product[0]["name"].'</h2>
                                <p><b style="color: #5D5A88; font-size: 36px; font-weight: 700; font-style:normal; line-height: 46px;">'.number_format ($product[0]["price"] * (1-$product[0]["sale_product"]/100) , $decimals = 0 , $dec_point = "," , $thousands_sep = "." ).'đ</b></p>
                                <p style="color: #5D5A88; font-size: 18px; font-weight: 400; font-style:normal; line-height: 34px;"> <b >Số lượng đã bán:</b> '.$product[0]["pay"].'</p>
                                ...
                                <span>
                                    <a href="javascript:void(0)" 
                                        ...
                                        idproduct = '.$product[0]["id"].'>
                                            ...
                                            <path d="M12.6667 4.66665H10.6667V3.99998C10.6667 3.29274 10.3858 2.61446 9.8857 2.11436C9.3856 1.61426 8.70732 1.33331 8.00008 1.33331C7.29284 1.33331 6.61456 1.61426 6.11446 2.11436C5.61437 2.61446 5.33341 3.29274 5.33341 3.99998V4.66665H3.33341C3.1566 4.66665 2.98703 4.73688 2.86201 4.86191C2.73699 4.98693 2.66675 5.1565 2.66675 5.33331V12.6666C2.66675 13.1971 2.87746 13.7058 3.25253 14.0809C3.62761 14.4559 4.13631 14.6666 4.66675 14.6666H11.3334C11.8638 14.6666 12.3726 14.4559 12.7476 14.0809C13.1227 13.7058 13.3334 13.1971 13.3334 12.6666V5.33331C13.3334 5.1565 13.2632 4.98693 13.1382 4.86191C13.0131 4.73688 12.8436 4.66665 12.6667 4.66665ZM6.66675 3.99998C6.66675 3.64636 6.80722 3.30722 7.05727 3.05717C7.30732 2.80712 7.64646 2.66665 8.00008 2.66665C8.3537 2.66665 8.69284 2.80712 8.94289 3.05717C9.19294 3.30722 9.33341 3.64636 9.33341 3.99998V4.66665H6.66675V3.99998ZM12.0001 12.6666C12.0001 12.8435 11.9298 13.013 11.8048 13.1381C11.6798 13.2631 11.5102 13.3333 11.3334 13.3333H4.66675C4.48994 13.3333 4.32037 13.2631 4.19534 13.1381C4.07032 13.013 4.00008 12.8435 4.00008 12.6666V5.99998H5.33341V6.66665C5.33341 6.84346 5.40365 7.01303 5.52868 7.13805C5.6537 7.26307 5.82327 7.33331 6.00008 7.33331C6.17689 7.33331 6.34646 7.26307 6.47149 7.13805C6.59651 7.01303 6.66675 6.84346 6.66675 6.66665V5.99998H9.33341V6.66665C9.33341 6.84346 9.40365 7.01303 9.52868 7.13805C9.6537 7.26307 9.82327 7.33331 10.0001 7.33331C10.1769 7.33331 10.3465 7.26307 10.4715 7.13805C10.5965 7.01303 10.6667 6.84346 10.6667 6.66665V5.99998H12.0001V12.6666Z" fill="white"/>
                                            </svg>
                                                Thêm Vào Giỏ Hàng
                                    </a>
                                </span>
                            ...
                            <div class="bg-light p-2 " style="margin-left: 5.5rem;">
                                    <div class="d-flex flex-row align-items-start">
                                        <textarea class="form-control ml-1 shadow-none textarea content-comment" id="content-comment"></textarea>
                                    </div>
                                    <div class=" text-right" style="margin-top: 1rem;">
                                        <button idproduct = '.$product[0]["id"].' class="btn-back shadow-none comment-product" type="button">Bình Luận</button>
                                    </div>
                                </div>
                            </div>
                            </div>
